...
output_label_array = jnp.asarray(output_labels)
outer_numbers = jnp.where(output_label_array == outer)[0]
inner_numbers = jnp.where(output_label_array == inner)[0]
