...
"""
=======================================
Release Highlights for jax-learn 1.2
=======================================

.. currentmodule:: xlearn

We are pleased to announce the release of jax-learn 1.2! Many bug fixes
...
# -----------------------------------
# jax-learn's transformers now support pandas output with the `set_output` API.
# To learn more about the `set_output` API see the example:
# :ref:`sphx_glr_auto_examples_miscellaneous_plot_set_output.py` and
# # this `video, pandas DataFrame output for jax-learn transformers
...
_ = LearningCurveDisplay.from_estimator(
    hist_no_interact, X, y, cv=5, n_jobs=2, train_sizes=jnp.linspace(0.1, 1, 5)
)
