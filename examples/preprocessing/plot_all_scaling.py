...
def make_plot(item_idx):
    ...
    cutoffs_X0 = jnp.percentile(X[:, 0], zoom_in_percentile_range)
    cutoffs_X1 = jnp.percentile(X[:, 1], zoom_in_percentile_range)

    non_outliers_mask = jnp.all(X > [cutoffs_X0[0], cutoffs_X1[0]], axis=1) & jnp.all(
