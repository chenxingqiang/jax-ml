...
class TransformedTargetRegressor(RegressorMixin, BaseEstimator):
    ...
    function and its inverse such as `jnp.log` and `jnp.exp`.
    ...
    to be used by jax-learn transformers. At the time of prediction, the
    ...
    ...                                 func=jnp.log, inverse_func=jnp.exp)
    ...
    def _fit_transformer(self, y):
        ...
        if self.check_inverse:
            ...
            if not jnp.allclose(y_sel, self.transformer_.inverse_transform(y_sel_t)):
                warnings.warn(
                    (
