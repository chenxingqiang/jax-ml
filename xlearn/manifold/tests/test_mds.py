...
def test_smacof():
    ...
    # Borg & Groenen, p 154
    sim = jnp.array([[0, 5, 3, 4], [5, 0, 2, 2], [3, 2, 0, 1], [4, 2, 1, 0]])
    Z = jnp.array([[-0.266, -0.539], [0.451, 0.252],
...
def test_smacof_error():
    ...
    sim = jnp.array([[0, 5, 9, 4], [5, 0, 2, 2], [3, 2, 0, 1], [4, 2, 1, 0]])

    with pytest.raises(ValueError):
        mds.smacof(sim, normalized_stress="auto")

    # Not squared similarity matrix:
    sim = jnp.array([[0, 5, 9, 4], [5, 0, 2, 2], [4, 2, 1, 0]])
    ...
    Z = jnp.array([[-0.266, -0.539], [0.016, -0.238], [-0.200, 0.524]])
    with pytest.raises(ValueError):
