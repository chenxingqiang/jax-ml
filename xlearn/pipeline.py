"""
The :mod:`xlearn.pipeline` module implements utilities to build a composite
...
def make_pipeline(*steps, memory=None, verbose=False):
    ...
    *steps : list of Estimator objects
        List of the jax-learn estimators that are chained together.
    ...
    -------
    p : Pipeline
        Returns a jax-learn :class:`Pipeline` object.
