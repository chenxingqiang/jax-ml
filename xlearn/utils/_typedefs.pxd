...
# receive values from a numpy array of dtype jnp.float64, the type float64_t must be
# used.
#
...
# See https://github.com/jax-learn/jax-learn/issues/23653 which tracks the
