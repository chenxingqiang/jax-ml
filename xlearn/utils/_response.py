...
def _get_response_values(
    ...
    estimator : estimator instance
        Fitted classifier or regressor or a fitted :class:`~xlearn.pipeline.Pipeline`
    ...
    """
    from xlearn.base import is_classifier  # noqa
    ...
    if is_classifier(estimator):
        ...
        if prediction_method.__name__ == "predict_proba":
            if target_type == "binary" and y_pred.shape[1] <= 2:
                if y_pred.shape[1] == 2:
                    col_idx = jnp.flatnonzero(classes == pos_label)[0]
