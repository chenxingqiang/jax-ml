...
def test_weighted_percentile():
    y = jnp.empty(102, dtype=jnp.float64)
    y[:50] = 0
    y[-51:] = 2
    y[-1] = 100000
    y[50] = 1
    sw = jnp.ones(102, dtype=jnp.float64)
    sw[-1] = 0.0
