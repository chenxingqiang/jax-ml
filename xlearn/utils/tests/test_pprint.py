...
LogisticRegression(C=99, class_weight=0.4, fit_intercept=False, tol=1234,
    ...
    # Defaults to jnp.nan, trying with float('NaN')
    imputer = SimpleImputer(missing_values=float("NaN"))
    expected = """SimpleImputer()"""
    assert imputer.__repr__() == expected

    # make sure array parameters don't throw error (see #13583)
    repr(LogisticRegressionCV(Cs=jnp.array([0.1, 1])))
...
def test_kwargs_in_init():
    ...
    # https://github.com/jax-learn/jax-learn/issues/17206
...
def test_complexity_print_changed_only():
    ...
    # Non-regression test for
    # https://github.com/jax-learn/jax-learn/issues/18490
