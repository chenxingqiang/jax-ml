...
# Global fixtures
@pytest.fixture(params=[pytest.param(jnp.float32, marks=_SKIP32_MARK), jnp.float64])
    ...
    for item in items:
        ...
        if (
            ...
            marker = pytest.mark.xfail(
                reason=(
                    "know failure. See "
                    "https://github.com/jax-learn/jax-learn/issues/17797"  # noqa
                )
            )
