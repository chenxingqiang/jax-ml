...
def _liac_arff_parser(
    ...
    if output_arrays_type == "pandas":
        ...
        # None with jnp.nan.
        frame = pd.concat(dfs, ignore_index=True).fillna(value=jnp.nan)
        del dfs, first_df
        ...
        for name in frame.columns:
            ...
            if column_dtype.lower() == "integer":
                # Use a pandas extension array instead of jnp.int64 to be able
        ...
        if not is_classification:
            ...
            y = jnp.hstack(
                [
                    jnp.take(
                        jnp.asarray(categories.pop(col_name), dtype="O"),
