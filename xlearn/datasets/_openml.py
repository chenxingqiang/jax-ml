...
def fetch_openml(
    ...
    *,
    ...
    target_column : str, list or None, default='default-target'
        ...
        are returned as multi-target (Note: not all jax-learn classifiers
    ...
    data : :class:`~xlearn.utils.Bunch`
        ...
        data : jnp.array, scipy.sparse.csr_matrix of floats, or pandas DataFrame
            The feature matrix. Categorical features are encoded as ordinals.
        target : jnp.array, pandas Series or DataFrame
