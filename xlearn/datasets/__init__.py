"""
The :mod:`xlearn.datasets` module includes utilities to load datasets,
...
def __getattr__(name):
    if name == "load_boston":
        msg = textwrap.dedent("""
            `load_boston` has been removed from jax-learn since version 1.2.
            ...
            The jax-learn maintainers therefore strongly discourage the use of
