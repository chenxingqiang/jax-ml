...
class SGDOptimizer(BaseOptimizer):
    ...
    def __init__(
        ...
        self.velocities = [jnp.zeros_like(param) for param in params]
...
class AdamOptimizer(BaseOptimizer):
    ...
    def __init__(
        ...
        self.t = 0
        self.ms = [jnp.zeros_like(param) for param in params]
        self.vs = [jnp.zeros_like(param) for param in params]
    ...
    def _get_updates(self, grads):
        ...
        self.learning_rate = (
            ...
            * jnp.sqrt(1 - self.beta_2**self.t)
            / (1 - self.beta_1**self.t)
        )
        updates = [
            -self.learning_rate * m / (jnp.sqrt(v) + self.epsilon)
