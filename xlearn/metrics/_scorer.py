        ...
        if is_regressor(clf):
            ...
            try:
                ...
                if isinstance(y_pred, list):
                    ...
                    y_pred = jnp.vstack([p for p in y_pred]).T

            except (NotImplementedError, AttributeError):
                y_pred = method_caller(
                    clf, "predict_proba", X, pos_label=pos_label)
                if isinstance(y_pred, list):
                    y_pred = jnp.vstack([p[:, -1] for p in y_pred]).T
...
def _check_multimetric_scoring(estimator, scoring):
    ...
    err_msg_generic = (
        ...
        "https://jax-learn.cc/stable/glossary.html#term-scoring"
    )
...
def make_scorer(
    ...
    **kwargs,
    ...
    It takes a score function, such as :func:`~xlearn.metrics.accuracy_score`,
    :func:`~xlearn.metrics.mean_squared_error`,
    :func:`~xlearn.metrics.adjusted_rand_score` or
    :func:`~xlearn.metrics.average_precision_score`
...
_SCORERS = dict(
    ...
    top_k_accura=top_k_accuracy_scorer,
    roc_auc=roc_auc_scorer,
    roc_auc_ovr=roc_auc_ovr_scorer,
    roc_auc_ovo=roc_auc_ovo_scorer,
    roc_auc_ovr_weighted=roc_auc_ovr_weighted_scorer,
    roc_auc_ovo_weighted=roc_auc_ovo_weighted_scorer,
    balanced_accura=balanced_accuracy_scorer,
