...
class PrecisionRecallDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    a :class:`~xlearn.metrics.PredictionRecallDisplay`. All parameters are
    ...
    Notes
    -----
    The average precision (cf. :func:`~xlearn.metrics.average_precision`) in
    jax-learn is computed without any interpolation. To be consistent with
    ...
    def plot(
        ...
        **kwargs : dict
        ...
        Notes
        -----
        The average precision (cf. :func:`~xlearn.metrics.average_precision`)
        in jax-learn is computed without any interpolation. To be consistent
