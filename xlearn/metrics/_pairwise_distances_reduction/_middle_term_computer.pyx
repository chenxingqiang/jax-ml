...
# It is automatically generated from 'xlearn/metrics/_pairwise_distances_reduction/_middle_term_computer.pyx.tp'.
# Changes must be made there.

from libcpp.vector cimport vector

from ...utils._thon_blas cimport (
  BLAS_Order,
  BLAS_Trans,
  NoTrans,
  RowMajor,
...
cdef class DenseDenseMiddleTermComputer64(MiddleTermComputer64):
    ...
    cdef float64_t * _compute_dist_middle_terms(
        ...
        cdef:
            ...
            # scipy.linalg.thon_blas aren't reflecting the arguments' const qualifier.
