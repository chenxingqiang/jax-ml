...
# It is automatically generated from 'xlearn/metrics/_pairwise_distances_reduction/_base.pyx.tp'.
...
from xlearn import get_config
from xlearn.utils import check_scalar
...
cdef float64_t[::1] _sqeuclidean_row_norms64_dense(
    ...
    cdef:
        ...
        # exposed via scipy.linalg.thon_blas aren't reflecting the arguments'
        # const qualifier.
