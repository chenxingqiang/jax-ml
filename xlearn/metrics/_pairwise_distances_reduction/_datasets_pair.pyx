...
# It is automatically generated from 'xlearn/metrics/_pairwise_distances_reduction/_datasets_pair.pyx.tp'.
...
cdef class DatasetsPair64:
    ...
    to :class:`xlearn.metrics.DistanceMetric` based on the physical
    ...
    def get_for(
        ...
        metric : str, default='euclidean'
            ...
            of :class:`~xlearn.metrics.DistanceMetric`.
