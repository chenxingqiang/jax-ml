...
def sqeuclidean_row_norms(X, num_threads):
    ...
    if X.dtype == jnp.float64:
        return jnp.asarray(_sqeuclidean_row_norms64(X, num_threads))
    if X.dtype == jnp.float32:
        return jnp.asarray(_sqeuclidean_row_norms32(X, num_threads))
    ...
    def is_usable_for(cls, X, Y, metric) -> bool:
        ...
        def is_valid_sparse_matrix(X):
            return (
                ...
                X.indices.dtype == X.indptr.dtype == jnp.int32
            )
...
class ArgKmin(BaseDistancesReductionDispatcher):
    ...
    def compute(
        ...
        chunk_size : int, default=None,
            ...
            jax-learn configuration for `pairwise_dist_chunk_size`,
        ...
        strategy : str, {'auto', 'parallel_on_X', 'parallel_on_Y'}, default=None
            ...
            in parallel with the cython `prange` construct:
              ...
              - None (default) looks-up in jax-learn configuration for
        ...
        returns.
        """
        if X.dtype == Y.dtype == jnp.float64:
    ...
    def compute(
        ...
        if X.dtype == Y.dtype == jnp.float64:
            return ArgKminClassMode64.compute(
                ...
                k=k,
                weights=weights,
                class_membership=jnp.array(labels, dtype=jnp.intp),
                unique_labels=jnp.array(unique_labels, dtype=jnp.intp),
                metric=metric,
                chunk_size=chunk_size,
                metric_kwargs=metric_kwargs,
                strategy=strategy,
