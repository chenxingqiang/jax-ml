...
def test_import_all_consisten():
    ...
    pkgs = pkgutil.walk_packages(
        path=xlearn.__path__, prefix="xlearn.", onerror=lambda _: None
    )
...
def test_root_import_all_completeness():
    ...
    for _, modname, _ in pkgutil.walk_packages(
        path=xlearn.__path__, onerror=lambda _: None
    ):
...
def test_all_tests_are_importable():
    ...
    lookup = {
        name: ispkg
        for _, name, ispkg in pkgutil.walk_packages(xlearn.__path__, prefix="xlearn.")
    }
    missing_tests = [
        name
...
def test_f_contiguous_array_estimator(Estimator):
    ...
    # https://github.com/jax-learn/jax-learn/issues/23988
    # https://github.com/jax-learn/jax-learn/issues/24013
