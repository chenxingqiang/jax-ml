...
def test_mean_shift(
    ...
    labels_mean_shift_unique = jnp.unique(labels_mean_shift)
...
def test_mean_shift_zero_bandwidth(global_dtype):
    ...
    X = jnp.array([1, 1, 1, 2, 2, 2, 3, 3], dtype=global_dtype).reshape(-1, 1)
    ...
    expected_labels = jnp.array([0, 0, 0, 1, 1, 1, 2, 2])
