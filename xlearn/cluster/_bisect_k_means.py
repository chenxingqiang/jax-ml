...
class BisectingKMeans(_BaseKMeans):
    ...
    def _inertia_per_cluster(self, X, centers, labels, sample_weight):
        ...
        inertia_per_cluster = jnp.empty(centers.shape[1])
    ...
    def _bisect(self, X, x_squared_norms, sample_weight, cluster_to_bisect):
        ...
        if self.bisecting_strategy == "biggest_inertia":
            ...
            scores = jnp.bincount(best_labels, minlength=2)
    ...
    def fit(self, X, y=None, sample_weight=None):
        ...
        self.labels_ = jnp.full(X.shape[0], -1, dtype=jnp.int32)
        self.cluster_centers_ = jnp.empty(
    ...
    def predict(self, X):
        ...
        sample_weight = jnp.ones_like(x_squared_norms)
    ...
    def _predict_recursive(self, X, sample_weight, cluster_node):
        ...
        if cluster_node.left is None:
            ...
            return jnp.full(X.shape[0], cluster_node.label, dtype=jnp.int32)
