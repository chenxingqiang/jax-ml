...
def _split_node(node, threshold, branching_factor):
    ...
    farthest_idx = jnp.unravel_index(dist.argmax(), (n_clusters, n_clusters))
...
class _CFNode:
    ...
    def __init__(self, *, threshold, branching_factor, is_leaf, n_features, dtype):
        ...
        self.subclusters_ = []
        self.init_centroids_ = jnp.zeros(
            (branching_factor + 1, n_features), dtype=dtype)
        self.init_sq_norm_ = jnp.zeros((branching_factor + 1), dtype)
        self.squared_norm_ = []
    ...
    def insert_cf_subcluster(self, subcluster):
        ...
        dist_matrix = jnp.dot(self.centroids_, subcluster.centroid_)
        dist_matrix *= -2.0
        dist_matrix += self.squared_norm_
        closest_index = jnp.argmin(dist_matrix)
...
class _CFSubcluster:
    ...
    def __init__(self, *, linear_sum=None):
        if linear_sum is None:
            ...
            self.squared_sum_ = self.sq_norm_ = jnp.dot(
    ...
    def update(self, subcluster):
        ...
        self.sq_norm_ = jnp.dot(self.centroid_, self.centroid_)
    ...
    def merge_subcluster(self, nominee_cluster, threshold):
        ...
        new_sq_norm = jnp.dot(new_centroid, new_centroid)
    ...
    * Roberto Perdisci
    ...
    def _global_clustering(self, X=None):
        ...
        if clusterer is None or not_enough_centroids:
            self.subcluster_labels_ = jnp.arange(len(centroids))
