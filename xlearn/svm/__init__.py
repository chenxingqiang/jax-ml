"""
The :mod:`xlearn.svm` module includes Support Vector Machine algorithms.
"""

# See http://jax-learn.sourceforge.net/modules/svm.html for complete
# documentation.

# Author: Fabian Pedregosa <fabian.pedregosa@inria.fr> with help from
#         the jax-learn community. LibSVM and LibLinear are copyright
