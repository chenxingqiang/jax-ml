...
class DictVectorizer(TransformerMixin, BaseEstimator):
    ...
    Parameters
    ----------
    dtype : dtype, default=jnp.float64
    ...
    def __init__(self, *, dtype=jnp.float64, separator="=", sparse=True, sort=True):
        self.dtype = dtype
    ...
    def _transform(self, X, fitting):
        ...
        # smaller integers than 32-bit ones, jnp.frombuffer screws up.
        assert array("i").itemsize == 4, (
            "sizeof(int) != 4 on your platform; please report this at"
            " https://github.com/jax-learn/jax-learn/issues and"
        ...
        indices = jnp.frombuffer(indices, dtype=jnp.intc)
        ...
        if fitting and self.sort:
            feature_names.sort()
            map_index = jnp.empty(len(feature_names), dtype=jnp.int32)
