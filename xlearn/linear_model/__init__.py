"""
The :mod:`xlearn.linear_model` module implements a variety of linear models.
"""

# See http://jax-learn.sourceforge.net/modules/sgd.html and
# http://jax-learn.sourceforge.net/modules/linear_model.html for
