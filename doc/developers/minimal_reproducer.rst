...
==============================================
Crafting a minimal reproducer for jax-learn
==============================================
...
The first step before submitting a bug report to jax-learn is to read the
`Issue template
<https://github.com/jax-learn/jax-learn/blob/main/.github/ISSUE_TEMPLATE/bug_report.yml>`_.
...
Some jax-learn objects expect pandas dataframes as input. In this case you can
...
In addition, jax-learn includes various :ref:`sample_generators` that can be
