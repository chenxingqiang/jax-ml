# jax-learn documentation build configuration file, created by
...
project = "jax-learn"
copyright = f"2007 - {datetime.now().year}, jax-learn developers (BSD License)"
...
html_short_title = "jax-learn"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "logos/jax-learn-logo-small.png"
...
htmlhelp_basename = "jax-learndoc"
...
latex_documents = [
    (
        "contents",
        "user_guide.tex",
        "jax-learn user guide",
        "jax-learn developers",
        "manual",
    ),
]
...
# the title page.
latex_logo = "logos/jax-learn-logo.png"
...
if v.release is None:
    raise ValueError(
        "Ill-formed version: {!r}. Version should follow PEP440".format(
            version)
    )
...
def notebook_modification_function(notebook_content, notebook_filename):
    ...
    message = (
        "Running the jax-learn examples in JupyterLite is experimental and you may"
        ...
        " [issue](https://github.com/jax-learn/jax-learn/issues/new/choose)"
        " about it."
    )
    ...
    if "skimage" in notebook_content_str:
        code_lines.append("%pip install jax-image")
...
# thumbnails for the front page of the jax-learn home page.
...
def generate_min_dependency_table(app):
    ...
    output.write(
        " ".join(
            ["=" * package_header_len, "=" *
                version_header_len, "=" * tags_header_len]
        )
    )
    output.write("\n")
...
issues_github_path = "jax-learn/jax-learn"
...
def setup(app):
    ...
    app.connect("builder-inited",
                disable_plot_gallery_for_linkcheck, priority=50)
...
linkcode_resolve = make_linkcode_resolve(
    "xlearn",
    (
        "https://github.com/jax-learn/"
        "jax-learn/blob/{revision}/"
...
ogp_site_url = "https://jax-learn/stable/"
ogp_image = "https://jax-learn.cc/stable/_static/jax-learn-logo-small.png"
ogp_use_first_image = True
ogp_site_name = "jax-learn"
